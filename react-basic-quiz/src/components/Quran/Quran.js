...
const qariMap = {
  mishary: {
    ...
    playlistId: "PLoqNzfHlA__knCeUoKUHjQfZpUL6mj64w",
  },
  saad: {
    displayName: "Saad Al-Ghamdi",
    playlistId: "PLhM2xiAUdw2cAqW_o3zZkbhJNw0bnaBZN",
  },
  sudais: {
    displayName: "Imam Sudais",
    playlistId: "PLwGJCASZfx4OKFE2TjvBhiNKUyfLa8f6B",
  },
  ...
  return (
    <div>
      ...
      <div className="quran-container">
        <h1 className="quran-header">
          Quranic Audios - {qariMap[selectedQari].displayName}
          <select
            className="qari-dropdown"
            value={selectedQari}
